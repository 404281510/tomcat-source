...
public class CheckOutThreadTest extends DefaultTestCase {
    ...
    public void testDBCPThreads10Connections10() throws Exception {
        ...
        System.out.println("[testDBCPThreads10Connections10]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
        tearDown();
    }
    ...
    public void testPoolThreads10Connections10() throws Exception {
        ...
        latch.await();
        long delta = System.currentTimeMillis() - start;
        System.out.println("[testPoolThreads10Connections10]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
        tearDown();
    }
    ...
    public void testPoolThreads10Connections10Fair() throws Exception {
        ...
        latch.await();
        long delta = System.currentTimeMillis() - start;
        System.out.println("[testPoolThreads10Connections10Fair]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
        tearDown();
    }

//    @org.apache.juli.Test
...
//        latch.await();
//        long delta = System.currentTimeMillis() - start;
//        System.out.println("[testC3P0Threads10Connections10]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
//        tearDown();
//    }
    ...
    public void testDBCPThreads20Connections10() throws Exception {
        ...
        latch.await();
        long delta = System.currentTimeMillis() - start;
        System.out.println("[testDBCPThreads20Connections10]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
        tearDown();
    }
    ...
    public void testPoolThreads20Connections10() throws Exception {
        ...
        latch.await();
        long delta = System.currentTimeMillis() - start;
        System.out.println("[testPoolThreads20Connections10]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
        tearDown();
    }
    ...
    public void testPoolThreads20Connections10Fair() throws Exception {
        ...
        latch.await();
        long delta = System.currentTimeMillis() - start;
        System.out.println("[testPoolThreads20Connections10Fair]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
        tearDown();
    }
...
//        latch.await();
//        long delta = System.currentTimeMillis() - start;
//        System.out.println("[testC3P0Threads20Connections10]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
//        tearDown();
//    }
    ...
    public void testDBCPThreads10Connections10Validate() throws Exception {
        ...
        latch.await();
        long delta = System.currentTimeMillis() - start;
        System.out.println("[testDBCPThreads10Connections10Validate]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
        tearDown();
    }
    ...
    public void testPoolThreads10Connections10Validate() throws Exception {
        ...
        latch.await();
        long delta = System.currentTimeMillis() - start;
        System.out.println("[testPoolThreads10Connections10Validate]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
        tearDown();
    }
    ...
    public void testPoolThreads10Connections10ValidateFair() throws Exception {
        ...
        latch.await();
        long delta = System.currentTimeMillis() - start;
        System.out.println("[testPoolThreads10Connections10ValidateFair]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
        tearDown();
    }
...
//        latch.await();
//        long delta = System.currentTimeMillis() - start;
//        System.out.println("[testC3P0Threads10Connections10Validate]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
//        tearDown();
//    }
    ...
    public void testDBCPThreads20Connections10Validate() throws Exception {
        ...
        latch.await();
        long delta = System.currentTimeMillis() - start;
        System.out.println("[testDBCPThreads20Connections10Validate]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
        tearDown();
    }
    ...
    public void testPoolThreads10Connections20Validate() throws Exception {
        ...
        latch.await();
        long delta = System.currentTimeMillis() - start;
        System.out.println("[testPoolThreads20Connections10Validate]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
        tearDown();
    }
    ...
    public void testPoolThreads10Connections20ValidateFair() throws Exception {
        ...
        latch.await();
        long delta = System.currentTimeMillis() - start;
        System.out.println("[testPoolThreads20Connections10ValidateFair]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
        tearDown();
    }
...
//        latch.await();
//        long delta = System.currentTimeMillis() - start;
//        System.out.println("[testC3P0Threads10Connections20Validate]org.apache.juli.Test complete:"+delta+" ms. Iterations:"+(threadcount*this.iterations));
//        tearDown();
//    }
